...
def parse_composition_input(user_str):
    """Parse input string with error handling"""
    try:
...
class CompositionApp:
    def __init__(self, root):
        ...
        # Fixed encoding issue: Used standard arrows
        ...
        self.input_text.pack(fill=tk.X) # Changed from BOTH to X so it doesn't expand vertically too much
